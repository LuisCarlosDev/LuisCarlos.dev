...
export default function CommandBar(props) {
  ...
  const actions = [
    ...
    },
    {
      ...
      keywords: 'send-email',
      section: 'Geral',
      perform: () => window.open('mailto:luisdevfullstack.dev@gmail.com', '_blank'),
    ...
    }, */
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://instagram.com/luis_carlos__ofc', '_blank'),
    ...
    },
    {
      ...
      keywords: 'go-github',
      section: 'Follow',
      perform: () => window.open('https://github.com/LuisCarlosDev', '_blank'),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://linkedin.com/in/luiscarlossilvaofc', '_blank'),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://app.rocketseat.com.br/me/luis-carlos-gomes-da-silva-1588146740', '_blank'),
